/*
	@file bumblebeeToCloud.cpp

	@author Sterling Baldwin
	@date	21 october 2013

	This file contains the implementation of the bumblebeeToCloud object
...
CloudPtr bumblebeeToCloud::getCloud()
{
	return data;
}


bumblebeeToCloud::bumblebeeToCloud()
{
...
CloudPtr bumblebeeToCloud::loadCloud()
{
