...
//=============================================================================
//=============================================================================
// $Id: TipDlg.cpp,v 1.1 2007/03/27 21:33:00 demos Exp $
//=============================================================================
   ...
   : CDialog(IDD_TIP, pParent)
{
   ...
   m_pStream = fopen("TriclopsDemoTips.txt", "r");
   if (m_pStream == NULL) 
   {
      m_bStartup = FALSE;
      return;
...
void 
CTipDlg::DoDataExchange(CDataExchange* pDX)
{
...
void 
CTipDlg::GetNextTipString(CString& strNext)
{
...
HBRUSH 
CTipDlg::OnCtlColor(CDC* pDC, CWnd* pWnd, UINT nCtlColor)
{
